...
export type TranscriptWhereInput = {
  ...
  fetchedAt?: Prisma.DateTimeFilter<"Transcript"> | Date | string
...
export type TranscriptScalarWhereWithAggregatesInput = {
  ...
  fetchedAt?: Prisma.DateTimeWithAggregatesFilter<"Transcript"> | Date | string
}
...
export type TranscriptOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "videoId" | "content" | "language" | "fetchedAt", ExtArgs["result"]["transcript"]>
...
export interface TranscriptFieldRefs {
  ...
  readonly fetchedAt: Prisma.FieldRef<"Transcript", 'DateTime'>
}
